  ...
  return (
    <footer className="bg-[#334B35] text-gray-300 p-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h3 className="text-xl font-medium mb-4">Useful Links</h3>
        ...
        <div>
          ...
          <form className="flex">
            ...
            />
            <button className="bg-yellow-500 text-gray-900 px-4 py-2 rounded-r-md">
              GO
            </button>
          </form>
        </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4">
        <div className="container mx-auto flex flex-col md:flex-row justify-between text-sm">
          <p className="mb-2 md:mb-0">
            Copyright ©Avillion Farms 2024. All Right Reserved.
          </p>
          <div className="flex space-x-4">
            <a href="#" className="hover:text-yellow-500">
              Terms & Conditions
