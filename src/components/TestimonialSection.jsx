...
function TestimonialSection() {
  ...
  return (
    <div className="py-8  flex-col flex items-center" id="testimonials">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <p className="text-sm  mb-3">OUR TESTIMONIALS</p>
          <h3 className="text-3xl  font-bold">WHAT ARE THEY TALKING ABOUT</h3>
        </div>
        <div>
