            ...
            <div className="p-4 bg-[#6D8C54] rounded-full mr-4">
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M12 8c1.5 0 3 1.5 3 3s-1.5 3-3 3-3-1.5-3-3 1.5-3 3-3zm0 0V5m0 11v2m-4-6H5m11 0h2M7.636 7.636L5.707 5.707m12.95 12.95l-1.93-1.93M7.636 16.364L5.707 18.293m12.95-12.95l-1.93 1.93"
                ></path>
              </svg>
            </div>
            <div>
